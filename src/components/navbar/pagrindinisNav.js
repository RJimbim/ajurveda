...
export default function PagrindinisNav() {
  ...
  return (
    <>
    <div className='pagrindinis-nav-container'>
      
        <nav className='nav'>
        <ul id="nav-top-menu" className={active}>
            <li id='pagrindinis-nav-first'><Link className='nav-h-menu-list' to="/pagrindinis" aria-current="page">Pagrindinis</Link></li>
            ...
            <div className='nav-menu'>
              <li id='pnav-mokymai' className='nav-h-menu-list' onClick={dropdownMenu}>Mokymai</li>
            ...
            <li className='nav-disable'><Link className='nav-h-menu-list' to="/parama">Parama</Link></li>
            <li className='nav-disable'><Link className='nav-h-menu-list' to="/apie">Apie mus ir partnerius</Link></li>
            <li className='nav-disable'><Link className='nav-h-menu-list' to="/naujienlaiskis">Naujienlaiškis</Link></li>
            <li className='nav-disable'><Link className='nav-h-menu-list' to="/archyvas">Archyvas</Link></li>
            <li className='nav-disable'><Link className='nav-h-menu-list' to="/kontaktai">Kontaktai</Link></li>
